...
describe("Testing in products routes", () => {
    ...
    test("should return PRODUCTS /api/products", async () => {
    ...
    test("should return a 404 NOT FOUND /api/products/:id", async () => {

        const { body } = await request(testServer.app)
            .get(`/api/products/199999`)
            .expect(400)

        expect(body).toEqual({ error: 'Producto con el id: 199999 no fue encontrado' })
    });

    test("should return a new PRODCUT /api/products/", async () => {
    ...
    test("should return an error empty product /api/products/", async () => {
    ...
    test("should return an update PRODUCT (INVENTORY ADJUSTMENT - inventory entry) /api/products/:id", async () => {
    ...
    test("should return an update PRODUCT (INVENTORY ADJUSTMENT - inventory outflow) /api/products/:id/inventory-adjustment", async () => {
    ...
    test("should return an error update PRODUCT (INVENTORY ADJUSTMENT) - empty payload  /api/products/:id/inventory-adjustment", async () => {
    ...
    test("should return an SEED PRODUCTS /api/products/seed", async () => {
